...
class tx_tone_ch1(gr.top_block):
    def __init__(self):
        ...
        print("[TX-TONE-CH1] freq:", freq)
        print("[TX-TONE-CH1] samp_rate:", samp_rate)
        print("[TX-TONE-CH1] tone:", tone)
        print("[TX-TONE-CH1] physical channel: [1], logical channel: 0")
